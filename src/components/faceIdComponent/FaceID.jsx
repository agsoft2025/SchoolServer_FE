...
export default function FaceRecognition({
  ...
  const captureFace = useCallback(
    async () => {
      ...
      if (!detections || detections.length === 0) {
        enqueueSnackbar("No face detected. Try again.", {
          variant: "warning",
        });
        return;
      }
  ...
  const startVideo = useCallback(() => {
    navigator.mediaDevices
      ...
      .then((stream) => {
        ...
        videoRef.current.onloadedmetadata = async () => {
          try {
            ...
            enqueueSnackbar("Unable to start video playback", {
              variant: "error",
            });
          }
        };
      ...
      .catch((error) => {
        ...
        enqueueSnackbar("Unable to access camera", {
          variant: "error",
        });
      });
  }, [enqueueSnackbar, startCountdown]);
  ...
  useEffect(() => {
    ...
    const loadModels = async () => {
      try {
        ...
        enqueueSnackbar("Unable to load face recognition models", {
          variant: "error",
        });
      }
    };
  ...
  }, [enqueueSnackbar, open, startVideo, stopCamera]);
